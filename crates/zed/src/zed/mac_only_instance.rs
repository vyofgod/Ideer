...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Ideer Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Ideer Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Ideer Editor Preview Instance Running",
        ReleaseChannel::Stable => "Ideer Editor Stable Instance Running",
    }
}
